INSERT INTO pub (place_id, name, frequency, day_of_week, time, timezone, address, lat, lng, city) VALUES (
  ...
  'Mackie Mayor', 'weekly', 1, "18:00", "Europe/London", 'Mackie Mayor, 1 Eagle Street, Manchester, M4 5BU, United Kingdom', 53.4854865,  -2.2348555, 'Manchester'
);
INSERT INTO pub (place_id, name, frequency, day_of_week, time, weeks_of_month, timezone, address, lat, lng, city) VALUES (
  ...
  'The Pen & Pencil', 'specific-weeks', 2, "19:30", '1,3', "Europe/London", 'The Pen & Pencil, 16 Tariff Street, Manchester, M1 2FN, United Kingdom', 53.4813709, -2.2316891, 'Manchester'
);
